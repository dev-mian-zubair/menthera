...
export const AnimatedFox: React.FC<AnimatedFoxProps> = ({
  size = 128,
  isActive = false,
  audioLevel = 0,
}) => {
    ...
    <View style={[styles.container, { width: size, height: size }]}>
      <Animated.View style={[styles.absoluteFill, breathingAnimatedStyle]}>
        ...
        <Svg width={size} height={size} viewBox="0 0 128 128" style={StyleSheet.absoluteFill}>
          ...
          {/* Nose */}
          <Path fill="#2f2f2f" d="M64 93.8c-5.2 0-9.3 2-8.7 5.1c.8 3.7 5.5 6.9 8.8 6.9c3.2 0 7.7-3 8.5-6.9c.6-2.6-3-5.1-8.6-5.1" />
          {/* Ear inner details */}
          ...
          <Path fill="#ffe0b2" d="M111.8 7.1c-1.8-2-9 .8-17.1 12.8c-4.2 6.3-4.7 14.4-4.7 14.4s1.9-2.8 5.7-2.3c.3 0 .6.4.4.7c-.5 1.2-1.6 4.2-.5 5.9c0 0 1.4-4 6.4-3.7c.4 0 .6.5.4.8c-.8 1.1-2.3 3.5-2.7 6.3c0 0 2-.1 3.9-2c.3-.3.8-.1.9.3c.1 1.2-.1 3-1.1 4.2c0 0 .8.4 1.8-.1c.4-.2.8.1.7.5c-.1.6-.2 1.4-.6 2.1c0 0 .5.2 1.4-.1c.3-.1.6 0 .7.4c.1.5.2 1.2 0 1.7c0 0 2.2 3.5 5 8.1c0 0 5.8-9.3 5.8-26c-.2-14.7-3.5-20.9-6.4-24" />
          {/* Mouth lines */}
          <Path fill="none" stroke="#2f2f2f" strokeMiterlimit="10" strokeWidth="3" d="M64.1 110.8v-6.9" />
          <Path fill="none" stroke="#2f2f2f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="3" d="M53 115.1c1.7.1 6.2.7 11.2-5.1" />
          <Path fill="none" stroke="#2f2f2f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="3" d="M75.3 115.1c-1.7.1-6.2.7-11.2-5.1" />
        ...
        <Animated.View
          style={[
            styles.eyeContainer,
            { left: 31 * scale, top: 60 * scale, width: 18 * scale, height: 20 * scale },
            eyeAnimatedStyle,
          ]}
        >
          <Svg width="100%" height="100%" viewBox="31 60 18 20">
            <Path fill="#2f2f2f" d="M36.8 67.1c.6-1.9 5.3-4.4 10.1-1.1c4.7 3.2 4.3 10.6 3.8 10.9c-.7.4-.9-.8-3.2-1.1c-1.5-.2-4.3.9-7.8-1.6c-3-2.1-3.3-5.8-2.9-7.1" />
          </Svg>
        </Animated.View>
        ...
        <Animated.View
          style={[
            styles.eyeContainer,
            { left: 75 * scale, top: 60 * scale, width: 18 * scale, height: 20 * scale },
            eyeAnimatedStyle,
          ]}
        >
          <Svg width="100%" height="100%" viewBox="75 60 18 20">
            <Path fill="#2f2f2f" d="M91.2 67.1c-.6-1.9-5.3-4.4-10.1-1.1c-4.7 3.2-4.3 10.6-3.8 10.9c.7.4.9-.8 3.2-1.1c1.5-.2 4.3.9 7.8-1.6c3-2.1 3.3-5.8 2.9-7.1" />
          </Svg>
        </Animated.View>
      </Animated.View>
    </View>
